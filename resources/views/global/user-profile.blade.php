              ...
              <div class="p-6 bg-white border-b border-gray-200 grid gap-4 grid-cols-3 ">
                  ...
                  <div class="col-span-2 content-center" >
                      ...
                      <div class="mt-4">
                        ...
                        <div class="grid grid-cols-4 font-normal text-sm mt-5">
                          <p> Email: </p>
                          <p class="col-span-3"> {{ $user->email }} </p>
                        </div>

                        <div class="grid grid-cols-4 font-normal text-sm mt-2">
                            <p>Mobile Number:</p>
                            
                            @isset($user->mobile_number)
                                <p class="col-span-3"> {{ $user->mobile_number }} </p>
                            @else
                                <p class="col-span-3"> Not Given </p>
                            @endisset
                        </div>

                        <div class="grid grid-cols-4 font-normal text-sm mt-2">
                            <p> Account type: </p>
                            <p class="col-span-3"> {{ $user->account_type }} </p>
                        </div>
