          ...
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
              <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div>
                    ...
                    <h2 class="font-bold text-2xl ">of <a class="text-lime-600" href="{{ route('institute.view-single', $department->institute_id ) }}">{{ $department->institute_name }}</a> </h2>
                    <span class="text-sm text-gray-500"> Department created: {{ date('j F, Y', strtotime($department->created_at)) }}
                    </span>
                </div>
                  ...
                  <div class="">
                      <h2 class="font-bold text-2xl"> Department Created by: </h2>
                      <div class="grid grid-cols-8 gap-2 mt-3 mb-5">

                          <div class="w-fit h-24 rounded-xl overflow-hidden">

                              @if (isset($department->creator_image) && file_exists('storage/profile_pictures/' . $department->creator_image))
                                  <img class=""
                                      src="{{ asset('storage/profile_pictures/' . $department->creator_image) }}"
                                      alt="Profile Picture">
                              @else
                          ...
                          <div class="col-span-3 ml-4 content-center">
                              <a href="{{ route('user.view', $department->creator_id) }}">
                                  <h4 class="font-bold text-md"> {{ $department->creator_name }} </h4>
                              </a>

                              <p class="font-normal text-sm">
                                  Email:
                                  {{ $department->creator_email }}
                              </p>

                              <p class="font-normal text-sm">
                                  Phone Number:
                                  {{ $department->creator_mobile_number ? $department->creator_mobile_number : 'Not given' }}
                              </p>
                          ...
                          <div class="col-span-4">
                              @if ($is_institute_admin)
                                  <form action="{{ route('institute.department.creator.update', [ $department->institute_id, $department->id]) }}" method="POST">
                                      @csrf
                                      ...
                                      <div class=" mt-5 mb-5">
                                          <div class=" grid grid-cols-2">
                                              <div class="w-full">
                                                  ...
                                                  <input name="new_creator" id="new_creator" type="hidden">

                                                  <div id="search-results"
                                                      class="absolute mt-1 bg-white border border-gray-300 rounded-md shadow-lg z-10 hidden max-h-60 overflow-y-auto">
                                              ...
                                              <div class="content-center">
                                                  ...
                                                  <div class="inline float-end">
                                                      <x-button class="outline outline-2 bg-indigo-600 ms-auto p-2">
                                                          Change Owner
                                                      </x-button>
                                                  </div>
                                  ...
                                  <script>
                                      ...
                                      $(document).ready(function() {
                                          ...
                                          function searchTeacher(searchTerm) {
                                              ...
                                              $.ajax({
                                                  url: "{{ route('search-institute-teacher', $department->institute_id) }}",
                                                  method: "GET",
                                                  data: {
                                                      search: searchTerm
                                                  },
                              ...
                              @else
                                  <div class="font-bold text-red-500 flex content-center">
                                      ...
                                      <p class="content-center ms-3">
                                          Only Institute admins can change Department Founder.
                                      </p>
                                  </div>
                              @endif
                  ...
                  <div class="mt-10">
                      <h2 class="font-bold text-2xl"> Head of the Department: </h2>
                      <div class="grid grid-cols-8 gap-2 mt-3 mb-5">

                          <div class="w-fit h-24 rounded-xl overflow-hidden">

                              @if (isset($department->department_head_image) &&
                                      file_exists('storage/profile_pictures/' . $department->department_head_image))
                                  <img class=""
                                      src="{{ asset('storage/profile_pictures/' . $department->department_head_image) }}"
                                      alt="Profile Picture">
                              @else
                                  <img class="" src="{{ asset('storage/default_images/pro_pic.jpg') }}"
                                      alt="Profile Picture">
                          ...
                          <div class="col-span-3 ml-4 content-center">
                              <a href="{{ route('user.view', $department->department_head_id) }}">
                                  <h4 class="font-bold text-md"> {{ $department->department_head_name }} </h4>
                              </a>

                              <p class="font-normal text-sm">
                                  Email:
                                  {{ $department->department_head_email }}
                              </p>

                              <p class="font-normal text-sm">
                                  Phone Number:
                                  {{ $department->department_head_mobile_number ? $department->department_head_mobile_number : 'Not given' }}
                              </p>
                          ...
                          <div class="col-span-4">
                              @if ( $is_institute_admin || $is_creator)
                                  <form action="{{ route('institute.department.head.update', [ $department->institute_id, $department->id]) }}" method="POST">
                                      @csrf
                              ...
                              @else
                                  <div class="font-bold text-red-500 flex content-center">
                                      ...
                                      <p class="content-center ms-3">
                                          Only Institute admins and Department Founder can change Department head
                                      </p>
                                  </div>
                              @endif
                  ...
                  @if ( $is_institute_admin || $is_creator || $is_head)

                  <form action="{{ route('institute.department.admin.update', [$department->institute_id, $department->id]) }}" method="POST">
                      @csrf
                          ...
                          <div class="grid grid-cols-8 gap-2 mt-3 mb-5">
                              ...
                              @if ( $is_institute_admin || $is_creator || $is_head)
                                  <div class="col-span-4 content-center text-right">
                                      ...
                                      <form
                                          action="{{ route('institute.department.admin.delete', [$department->institute_id, $department->id]) }}"
                                          class="ms-auto inline" 
                                          method="POST">
                                          @csrf
                                          @method('DELETE')

                                          <input type="hidden" name="admin_to_delete" value="{{ $admin->id }}">
                              ...
                              @elseif ($admin->id == $userId)
                                  <div class="col-span-4 content-center text-right">
                                      <form
                                          action="{{ route('institute.department.admin.delete', [ $department->institute_id, $department->id, $admin->id]) }}"
